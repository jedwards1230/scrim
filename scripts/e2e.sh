...
EVENTS_URL="${CANVAS_URL%/}/__events"
...
# --- Scenario 4: stop cleanly stops the daemon, canvas files survive ---
log "Scenario 4: stop cleanly stops the daemon; canvas files survive"
...
# --- Scenario 5: idle-exit ---
log "Scenario 5: daemon exits on its own after --idle-timeout with no SSE clients"
DIR5="$WORKDIR/s5"
...
# --- Scenario 6: stale-pid recovery ---
log "Scenario 6: stale-pid recovery after a simulated crash"
DIR6="$WORKDIR/s6"
...
# --- Scenario 7: double-start race converges on one daemon ---
log "Scenario 7: concurrent adds converge on exactly one daemon"
DIR7="$WORKDIR/s7"
