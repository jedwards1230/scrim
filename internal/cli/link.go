...
// it launch a browser. It's the verb agents (and the scrim agent skill under
// plugins/) should reach for by default, since open's browser auto-launch is
// opt-in specifically for a human operator asking for it -- an agent should
// never be the one flipping that switch on someone else's machine.
